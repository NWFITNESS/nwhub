...
const variantStyles: Record<BadgeVariant, string> = {
  ...
  active:       'bg-[rgba(74,222,128,0.12)]  text-[#22c55e] border border-[rgba(74,222,128,0.22)]',
  paused:       'bg-[rgba(100,116,139,0.12)] text-nw-400    border border-[rgba(255,255,255,0.09)]',
  sent:         'bg-[rgba(74,222,128,0.12)]  text-[#22c55e] border border-[rgba(74,222,128,0.22)]',
  ...
  new:          'bg-[rgba(74,222,128,0.12)]  text-[#22c55e] border border-[rgba(74,222,128,0.22)]',
  read:         'bg-[rgba(100,116,139,0.12)] text-nw-400    border border-[rgba(255,255,255,0.09)]',
  replied:      'bg-[rgba(74,222,128,0.12)]  text-[#22c55e] border border-[rgba(74,222,128,0.22)]',
  published:    'bg-[rgba(74,222,128,0.12)]  text-[#22c55e] border border-[rgba(74,222,128,0.22)]',
  subscribed:   'bg-[rgba(74,222,128,0.12)]  text-[#22c55e] border border-[rgba(74,222,128,0.22)]',
  ...
  green:        'bg-[rgba(74,222,128,0.12)]  text-[#22c55e] border border-[rgba(74,222,128,0.22)]',
}
