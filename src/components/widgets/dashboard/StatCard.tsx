...
export function StatCard({ label, value, icon: Icon, iconBg, trend, alert, alertLabel = 'Needs attention' }: StatCardProps) {
  return (
    <div className="bg-[#161616] border border-white/[0.06] rounded-xl p-3 @md/page:p-6 min-h-[110px] @md/page:min-h-[130px] flex flex-col justify-between hover:border-[#967705]/30 transition-colors duration-200 h-full">
