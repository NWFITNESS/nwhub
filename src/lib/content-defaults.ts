...
export const PAGE_SECTION_DEFAULTS: Record<string, Record<string, Record<string, unknown>>> = {
  ...
  // ── Programmatic town pages (kids-classes/*) ──────────────────────────────
  // These defaults apply to any kids-classes/<town> page in the content editor.
  // The town name is appended dynamically. Image fields show the media picker
  // with focal point automatically.
  'kids-classes/whitehaven': {
    ...
    town_gallery: {
      heading: 'Whitehaven warriors in action',
      items: [
        { image_url: '', alt: 'Kids session photo 1', image_position: '50% 50%' },
        { image_url: '', alt: 'Kids session photo 2', image_position: '50% 50%' },
        { image_url: '', alt: 'Kids session photo 3', image_position: '50% 50%' },
    ...
    town_feature_image: {
      ...
      caption: 'Our gym in Egremont — just 12 minutes from Whitehaven',
    },
  },
}
