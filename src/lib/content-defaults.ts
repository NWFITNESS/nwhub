...
export const PAGE_SECTION_DEFAULTS: Record<string, Record<string, Record<string, unknown>>> = {
  ...
  'personal-training': {
    ...
    testimonials: {
      items: [
        { quote: "Kieran made me feel at ease from day one. He's a proper sound bloke — knows his stuff but doesn't take himself too seriously.", name: 'NW Member', role: '1-to-1 Client', category: 'PT' },
        { quote: "Every session is different, challenging and actually fun. Kieran pushes you but in a way that makes you want to come back.", name: 'NW Member', role: '1-to-1 Client', category: 'PT' },
        { quote: "The best thing about training with Kieran is how much he actually cares. He checks in, adjusts the plan, and genuinely wants to see you win.", name: 'NW Member', role: '1-to-1 Client', category: 'PT' },
        { quote: "I'd never done PT before and was nervous. Kieran was so relaxed and genuine about it — within a week I felt like I'd been training with him for years.", name: 'NW Member', role: '1-to-1 Client', category: 'PT' },
        { quote: "Kieran helped me sort my nutrition without making it feel like a diet. Practical advice that actually fits around real life.", name: 'NW Member', role: 'Nutrition Client', category: 'Nutrition' },
        { quote: "The nutrition coaching alongside my training made everything click. I'm recovering better, performing better, and I actually enjoy eating again.", name: 'NW Member', role: 'Nutrition Client', category: 'Nutrition' },
        { quote: "Kieran doesn't overcomplicate it. He gave me a framework I could follow and adjusted as we went. Simple, effective, sustainable.", name: 'NW Member', role: 'Nutrition Client', category: 'Nutrition' },
        { quote: "I'd tried loads of nutrition plans before. Kieran's approach was the first one that actually stuck — no restriction, just structure.", name: 'NW Member', role: 'Nutrition Client', category: 'Nutrition' },
        { quote: "The online programming is brilliant. I get my sessions planned out, check in regularly, and I've seen more progress in 3 months than the last year.", name: 'NW Member', role: 'Online Client', category: 'Programming' },
        { quote: "I wanted to focus on my weaknesses before a competition. Kieran put together a block that addressed exactly what I needed.", name: 'NW Member', role: 'Competition Prep', category: 'Programming' },
        { quote: "Having someone else take the thinking out of my training has been a game-changer. I just show up and execute.", name: 'NW Member', role: 'Online Client', category: 'Programming' },
        { quote: "Kieran programmed around my shifts and my injuries. It's the first time training has felt manageable AND progressive.", name: 'NW Member', role: 'Online Client', category: 'Programming' },
      ],
    },
    pt_contact: {
      heading: 'Get in Touch',
